#!/usr/bin/env bash
# run_ds10_trace.sh -- DS10 comprehensive SRM trace (full retire firehose -> traces/*.trc).
...
#   ./tools/run_ds10_trace.sh [relwithdebinfo|debug|release] [rebuild] [-- extra Emulatr args]
